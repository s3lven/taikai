...
describe('Tournament Edit Dialog', () => {
    it('renders the edit dialog with tournament name', () => {
      ...
      expect(screen.getByPlaceholderText('NCKF Taikai')).toHaveValue(mockTournament.name);
    });
    ...
    it('updates tournament on form submission', async () => {
      ...
      const updatedTournament = result.current.tournaments.find(t => t.id === mockTournament.id);
  ...
  describe('Tournament New Dialog', () => {
    ...
    it('prevents submission of invalid tournament name', async () => {
      ...
      expect(screen.getByText('Name must be longer than 2 characters')).toBeInTheDocument();
  ...
  describe('Tournament View Dialog', () => {
    it('renders tournament details and brackets', () => {
      ...
      expect(screen.getByText('Beginner Bracket')).toBeInTheDocument();
    });
